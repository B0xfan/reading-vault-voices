...
- `lexicon/phonemize-exceptions.json.gz`: pronunciations for words the lists
  above miss, from [phonemize](https://github.com/hans00/phonemize), MIT.
...
Everything here is under the Apache License 2.0 (`LICENSE`), except the
phonemize exception list (MIT, `LICENSE-phonemize-MIT.txt`), with attribution
